...
class DisDelegate(QStyledItemDelegate):
    ...
    def initStyleOption(self, option: 'QStyleOptionViewItem', index: QModelIndex) -> None:
        ...
        if not model.hideMode:
            ...
            if model.dirModel.isDir(index):
                qdir = QDir(model.dirModel.filePath(index))
                if model.nameFilters:
                ...
                if qdir.match(model.nameFilters, model.dirModel.fileName(index)):
                    # return model.enabled
                    pass
                else:
...
class FileSystemView(QWidget):
    ...
    def enableHide(self):
        self.dirProxy.hideMode = not self.dirProxy.hideMode
        self.dirProxy.invalidateFilter()
    ...
    def UI_Init(self):
        ...
        self.dirProxy.dirModel.setRootPath(workstation_files)
        self.dirProxy.setNameFilters(project_filenames_as_filter)
        ...
        root_index = self.dirProxy.dirModel.index(workstation_files)
